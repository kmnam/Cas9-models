 ...
 * - live specific associativity with respect to the distal-mismatch substrate 
...
VectorXd computeCleavageStats(const Ref<const VectorXd>& input)
{
    ...
    // Compute cleavage probability and live unbinding rate on the
...
int main(int argc, char** argv)
{
    ...
    std::stringstream ss;
    ss << argv[3] << "-spec-assoc-live-mm" << argv[4] << "-boundary";
