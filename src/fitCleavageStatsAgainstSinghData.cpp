...
Matrix<PreciseType, Dynamic, 5> computeCleavageStats(const Ref<const Matrix<PreciseType, Dynamic, 1> >& logrates,
                                                     ...
                                                     const PreciseType log_terminal_unbind_rate, 
                                                     const PreciseType log_terminal_cleave_rate,
                                                     const PreciseType log_terminal_bind_rate,
                                                     ...
                                                     const bool normalize = true)
{
    ...
    PreciseType terminal_unbind_rate = pow(ten, log_terminal_unbind_rate); 
    PreciseType terminal_cleave_rate = pow(ten, log_terminal_cleave_rate); 

    // Binding rate entering state 0
    PreciseType bind_rate = pow(ten, log_terminal_bind_rate);
                             ...
                             const bool normalize = true)
{
    ...
    if (normalize)
    {
        ...
        stats1 = computeCleavageStats(
            logrates, cleave_seqs, log_terminal_unbind_rate, log_terminal_cleave_rate,
            log_terminal_bind_rate, bind_conc, true
        );
        stats2 = computeCleavageStats(
            logrates, unbind_seqs, log_terminal_unbind_rate, log_terminal_cleave_rate,
            log_terminal_bind_rate, bind_conc, true
        );
    ...
    else 
    {
        ...
        stats1 = computeCleavageStats(
            logrates, cleave_seqs, log_terminal_unbind_rate, log_terminal_cleave_rate,
            log_terminal_bind_rate, bind_conc, false
        );
        stats2 = computeCleavageStats(
            logrates, unbind_seqs, log_terminal_unbind_rate, log_terminal_cleave_rate,
            log_terminal_bind_rate, bind_conc, false
...
void fitCleavageStats(const std::string outfilename,
                      const PreciseType log_terminal_unbind_rate, 
                      const PreciseType log_terminal_cleave_rate,
                      const PreciseType log_terminal_bind_rate,
                      const PreciseType bind_conc, const int n_init,
                      boost::random::mt19937& rng)
{
    ...
    constraints_opt->parse("/Users/kmnam/Dropbox/gene-regulation/projects/Cas9-models/polytopes/line-10.poly");
    ...
    Polytopes::parseVerticesFile(
        "/Users/kmnam/Dropbox/gene-regulation/projects/Cas9-models/polytopes/line-5.vert", 
        tri
    );
    ...
    for (int j = 0; j < 3; ++j)
    {
        ...
        for (int i = 0; i < n_init; ++i)
        {
            ...
            best_fit(i, Eigen::seqN(j * D, D)) = opt->run([
                ...
                &log_terminal_unbind_rate, &log_terminal_cleave_rate, &log_terminal_bind_rate,
                &bind_conc 
            ](
            ...
            )
                {
                    return errorAgainstData(
                        ...
                        curr_unbind_data, log_terminal_unbind_rate, 
                        log_terminal_cleave_rate, log_terminal_bind_rate,
                        bind_conc, true 
                    ); 
                },
            ...
            errors(i, j) = errorAgainstData(
                ...
                curr_unbind_seqs, curr_unbind_data, log_terminal_unbind_rate,
                log_terminal_cleave_rate, log_terminal_bind_rate, bind_conc, true
            );
            ...
            Matrix<PreciseType, Dynamic, 5> curr_fit_stats = computeCleavageStats(
                ...
                log_terminal_unbind_rate, log_terminal_cleave_rate, 
                log_terminal_bind_rate, bind_conc, false
            );
...
int main(int argc, char** argv)
{
    ...
    const PreciseType log_terminal_unbind_rate = static_cast<PreciseType>(std::stod(argv[2]));
    const PreciseType log_terminal_cleave_rate = static_cast<PreciseType>(std::stod(argv[3]));
    const PreciseType log_terminal_bind_rate = static_cast<PreciseType>(std::stod(argv[4]));
